                ...
                ============================================= -->
                    <div id="top-social">
                        <ul>
                            ...
                            <?php } ?>
                            <?php
                            if (get_theme_mod('wu_mail_address')) { ?>
                                <li><a href="mailto:<?php echo get_theme_mod('wu_mail_address') ?>" class="si-email3"><span class="ts-icon"><i class="icon-email3"></i></span><span class="ts-text"><?php echo get_theme_mod('wu_mail_address') ?></span></a></li>
                            <?php } ?>
            ...
            ============================================= -->
                <nav id="primary-menu" class="style-2">
                    ...
                    <div class="container clearfix">
                        ...
                        <?php
                        if (get_theme_mod('wu_header_show_cart')) { ?>
                            <!-- Top Cart
                            ============================================= -->
                            <div id="top-cart">
                        ...
                        <?php
                        if (get_theme_mod('wu_header_show_search')) { ?>
                            <!-- Top Search
                        ============================================= -->
                            <div id="top-search">
